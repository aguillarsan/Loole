      ...
      <div id="appCapsule">
        <div id="publish_post">
                ...
                <div :id="'img' + key" v-if="image.type.match('image.*')">
                  ...
                  <div class="btn_close_img_post_add">
                    <a @click="removefile(key)">
                      <ion-icon aria-label="star-outline" class="md hydrated" name="trash-outline" role="img"
          ...
          <div class="dv-btn-publish">
            <button @click.prevent="add_img()" class="btn btn-icon btn-lg bg-primary-loole btn-primary me-1 mb-1"
              style="border-radius: 100px; width: 55px; height: 55px" type="button">
          ...
          <input @change="onFileChange" accept="image/video/*" hidden="true" id="file_post_looler_img" multiple="true"
            ref="loolerPost" type="file" />
          <div class="section full mt-2 mb-2">
            <div class="wide-block pb-1 pt-2" style="border-bottom: none">
              <form>
                <div class="form-group boxed">
                  <div class="input-wrapper" style="padding: 0 0px !important">
                    ...
                    <textarea class="form-control" id="address5" maxlength="300" rows="4" style="font-size: 13px"
                ...
                <ul class="listview simple-listview no-border-top-bottom">
                  <li style="padding: 0 0px">
                    ...
                    <div class="form-check form-switch">
                      <input @change="activateInput()" class="form-check-input" id="SwitchCheckDefault1" type="checkbox"
                        v-model="inputs.premiun" />
                  ...
                  <li style="padding: 0 0px">
                    ...
                    <div class="form-check form-switch">
                      <money class="form-control" disabled="true" id="inputMoney" style="width: 100px" v-bind="money"
              ...
              <div class="mt-5">
                <button @click="publish()" class="btn btn-primary bg-primary-loole btn-block btn-lg rounded"
                  type="submit">
                  Publicar
                </button>
              </div>
