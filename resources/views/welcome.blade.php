        ...
        <div class="section full mt-3 mb-3">
            ...
            <div class="carousel-multiple splide splide--loop splide--ltr splide--draggable is-active" id="splide01" style="visibility: visible;">
                <div class="splide__track" id="splide01-track" style="padding-left: 16px; padding-right: 16px;">
                    <ul class="splide__list" id="splide01-list" style="transform: translateX(-3079.5px);">
                        <li class="splide__slide splide__slide--clone" aria-hidden="true" tabindex="-1" style="margin-right: 16px; width: 300.75px;">
                            <div class="card">
                        ...
                        </li><li class="splide__slide splide__slide--clone" aria-hidden="true" tabindex="-1" style="margin-right: 16px; width: 300.75px;">
                            <div class="card">
                        ...
                        </li><li class="splide__slide splide__slide--clone" style="margin-right: 16px; width: 300.75px;">
                            <div class="card">
                        ...
                        </li><li class="splide__slide" id="splide01-slide01" aria-hidden="true" tabindex="-1" style="margin-right: 16px; width: 300.75px;">
                            <div class="card">
                                <img src="assets/img/sample/photo/d1.jpg" class="card-img-top" alt="image">
                                <div class="card-body pt-2">
                                    <h4 class="mb-0">Progressive web app ready</h4>
                        ...
                        <li class="splide__slide" id="splide01-slide02" aria-hidden="true" tabindex="-1" style="margin-right: 16px; width: 300.75px;">
                            <div class="card">
                                <img src="assets/img/sample/photo/d2.jpg" class="card-img-top" alt="image">
                                <div class="card-body pt-2">
                                    <h4 class="mb-0">Reusable components</h4>
                        ...
                        <li class="splide__slide is-visible is-active" id="splide01-slide03" aria-hidden="false" tabindex="0" style="margin-right: 16px; width: 300.75px;">
                            <div class="card">
                                <img src="assets/img/sample/photo/d3.jpg" class="card-img-top" alt="image">
                                <div class="card-body pt-2">
                                    <h4 class="mb-0">Great for phones &amp; tablets</h4>
                        ...
                        <li class="splide__slide" id="splide01-slide04" aria-hidden="true" tabindex="-1" style="margin-right: 16px; width: 300.75px;">
                            <div class="card">
                                <img src="assets/img/sample/photo/d4.jpg" class="card-img-top" alt="image">
                                <div class="card-body pt-2">
                                    <h4 class="mb-0">Change the styles in sass</h4>
                        ...
                        <li class="splide__slide" id="splide01-slide05" style="margin-right: 16px; width: 300.75px;" aria-hidden="true" tabindex="-1">
                            <div class="card">
                                <img src="assets/img/sample/photo/d6.jpg" class="card-img-top" alt="image">
                                <div class="card-body pt-2">
                                    <h4 class="mb-0">Sketch source file included</h4>
                        ...
                        <li class="splide__slide" id="splide01-slide06" style="margin-right: 16px; width: 300.75px;" aria-hidden="true" tabindex="-1">
                            <div class="card">
                                <img src="assets/img/sample/photo/d7.jpg" class="card-img-top" alt="image">
                                <div class="card-body pt-2">
                                    <h4 class="mb-0">RTL (Right to Left) Support</h4>
                        ...
                        <li class="splide__slide" id="splide01-slide07" style="margin-right: 16px; width: 300.75px;">
                            <div class="card">
                                <img src="assets/img/sample/photo/d5.jpg" class="card-img-top" alt="image">
                                <div class="card-body pt-2">
                                    <h4 class="mb-0">Written with a code structure</h4>
                    ...
                    <li class="splide__slide splide__slide--clone" style="margin-right: 16px; width: 300.75px;">
                            <div class="card">
                                <img src="assets/img/sample/photo/d1.jpg" class="card-img-top" alt="image">
                                <div class="card-body pt-2">
                                    <h4 class="mb-0">Progressive web app ready</h4>
                        ...
                        </li><li class="splide__slide splide__slide--clone is-visible" style="margin-right: 16px; width: 300.75px;" aria-hidden="false" tabindex="0">
                            <div class="card">
                                <img src="assets/img/sample/photo/d2.jpg" class="card-img-top" alt="image">
                                <div class="card-body pt-2">
                                    <h4 class="mb-0">Reusable components</h4>
